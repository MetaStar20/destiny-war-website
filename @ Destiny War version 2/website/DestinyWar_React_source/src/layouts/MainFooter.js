      ...
      <Container maxWidth="lg">
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={{ xs: 1 }} sx={{ justifyContent: "space-around" }}>
          <Stack direction="row" justifyContent="center" alignItems="center">
            <Typography variant="h4">MADE IN</Typography>
            <Box
              component="img"
              src="/unity.png"
              sx={{ height: "1.5rem", pl: 1 }}
            />
          </Stack>
          <Stack direction="row" justifyContent="center" alignItems="center">
        ...
        <Stack>
          <Stack direction="row" sx={{ justifyContent: "center", pt: 3, pb: 1 }}>
            <Typography variant="h4">IN PARTNERSHIP WITH</Typography>
          </Stack>
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={{ xs: 2 }} sx={{ justifyContent: "space-around" }}>
            <Box>
              ...
              />
              <Typography variant="h4">PANCAKE</Typography>
            </Box>
            <Box>
              <Box 
                component="img"
              ...
              />
              <Typography variant="h4">COINGECKO</Typography>
            </Box>
            <Box>
              <Box 
                component="img"
              ...
              />
              <Typography variant="h4">POOCOIN</Typography>
            </Box>
          </Stack>
        ...
        <Typography variant="h4" color="#014c2d">
