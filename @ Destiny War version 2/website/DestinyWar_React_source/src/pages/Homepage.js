...
export default function Homepage() {
  ...
  return (
    <Box sx={{ mt: "-146px" }}>
      <Box component="img" src="/playexpedition.png"
        sx={{
          position: 'fixed',
          width: 300,
          right: 0,
      ...
      />
      <a href="https://destinywar.io/game/" target="_blank">
        <Box component="img" src="/clicktoplay.png" 
          sx={{
            position: 'fixed',
            width: 250,
            right: '70px',
      ...
      <Box
        component="img"
        src="/divider.png"
        sx={{ width: 1, mt: { xs: "-36px", md: "-65px" }, zIndex: 999 }}
      />
