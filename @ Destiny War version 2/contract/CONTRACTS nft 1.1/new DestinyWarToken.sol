...
contract DestinyWarCoin is Context, IERC20, Ownable {
    ...
    string private _name = "DestinyWar";
    string private _symbol = "DWAR";
    ...
    address public marketingWallet = 0x6dBf2D80643B76EA5a2611245DeA2aC1757B4c07;
    address public devWallet = 0x6eF58Fba913c3389645bd09302cFD545437FEE43 ;
    ...
    returns (uint256, uint256)
    {
        ...
        uint256 tMarketing = tAmount.div(1000).mul(_marketingFee);
   ...
   function takeDev(address sender, uint256 tTransferAmount, uint256 rTransferAmount, uint256 tAmount) private
    returns (uint256, uint256)
    {
        ...
        uint256 tdev = tAmount.div(1000).mul(_devFee);
